...
RcppExport SEXP OncoSimulR_nr_BNB_Algo5(SEXP rFESEXP, SEXP mu_SEXP, SEXP deathSEXP, SEXP initSizeSEXP, SEXP sampleEverySEXP, SEXP detectionSizeSEXP, SEXP finalTimeSEXP, SEXP initSpSEXP, SEXP initItSEXP, SEXP seedSEXP, SEXP verbositySEXP, SEXP speciesFSSEXP, SEXP ratioForceSEXP, SEXP typeFitness_SEXP, SEXP maxramSEXP, SEXP mutationPropGrowthSEXP, SEXP initMutant_SEXP, SEXP maxWallTimeSEXP, SEXP keepEverySEXP, SEXP KSEXP, SEXP detectionDriversSEXP, SEXP onlyCancerSEXP, SEXP errorHitWallTimeSEXP, SEXP maxNumTriesSEXP, SEXP errorHitMaxTriesSEXP, SEXP minDetectDrvCloneSzSEXP, SEXP extraTimeSEXP, SEXP keepPhylogSEXP, SEXP MMUEFSEXP, SEXP full2mutator_SEXP, SEXP n2SEXP, SEXP p2SEXP, SEXP PDBaselineSEXP, SEXP cPDetect_iSEXP, SEXP checkSizePEverySEXP, SEXP AND_DrvProbExitSEXP, SEXP fixation_listSEXP, SEXP maxFitnessSEXP, SEXP initMutantPercentageSEXP, SEXP cteSizeSEXP, SEXP migrationProbSEXP, SEXP largeDistanceMigrationProbSEXP, SEXP maxMigrationPercentageSEXP, SEXP spatialModelSEXP, SEXP spatialDemesMaxSEXP, SEXP spatialIterMaxSEXP, SEXP spatialKeepEverySEXP, SEXP spatialVerbositySEXP, SEXP spatialDeleteDemesWithoutMutationsSEXP)
{
    ...
    Rcpp::traits::input_parameter<double>::type maxFitness(maxFitnessSEXP);
    Rcpp::traits::input_parameter<double>::type initMutantPercentage(initMutantPercentageSEXP);
    Rcpp::traits::input_parameter<double>::type cteSize(cteSizeSEXP);
    Rcpp::traits::input_parameter<double>::type migrationProb(migrationProbSEXP);
    Rcpp::traits::input_parameter<double>::type largeDistanceMigrationProb(largeDistanceMigrationProbSEXP);
    Rcpp::traits::input_parameter<double>::type maxMigrationPercentage(maxMigrationPercentageSEXP);
    Rcpp::traits::input_parameter<bool>::type spatialModel(spatialModelSEXP);
    Rcpp::traits::input_parameter<int>::type spatialDemesMax(spatialDemesMaxSEXP);
    Rcpp::traits::input_parameter<int>::type spatialIterMax(spatialIterMaxSEXP);
    Rcpp::traits::input_parameter<int>::type spatialKeepEvery(spatialKeepEverySEXP);
    Rcpp::traits::input_parameter<int>::type spatialVerbosity(spatialVerbositySEXP);
    Rcpp::traits::input_parameter<bool>::type spatialDeleteDemesWithoutMutations(spatialDeleteDemesWithoutMutationsSEXP);

    __result = Rcpp::wrap(nr_BNB_Algo5(rFE, mu_, death, initSize, sampleEvery, detectionSize, finalTime, initSp, initIt, seed, verbosity, speciesFS, ratioForce, typeFitness_, maxram, mutationPropGrowth, initMutant_, maxWallTime, keepEvery, K, detectionDrivers, onlyCancer, errorHitWallTime, maxNumTries, errorHitMaxTries, minDetectDrvCloneSz, extraTime, keepPhylog, MMUEF, full2mutator_, n2, p2, PDBaseline, cPDetect_i, checkSizePEvery, AND_DrvProbExit, fixation_list, maxFitness, initMutantPercentage, cteSize, migrationProb, largeDistanceMigrationProb, maxMigrationPercentage, spatialModel, spatialDemesMax, spatialIterMax, spatialKeepEvery, spatialVerbosity, spatialDeleteDemesWithoutMutations));
    return __result;
END_RCPP
}
// BNB_Algo5
